...
public abstract class BankUtils extends LoopScript {
    ...
    public static List<String> createShoppingListItems(List<String> items, List<Integer> quantities) {
        ...
        for(String item : items) {
            ...
            if(!doesBankHaveItemWithQuantity(item, quantities.get(i)) && !item.contains("Coins")) {
    ...
    public static void depositEquipment() { stx.bank().depositEquipment(); }
    ...
    public boolean doesBankHaveItems(List<String> items) {
        for(String item : items) {
